...
namespace MandiParishadWebApi.Models
{
    public class AdminContext : DbContext
    {
        ...
        public string ComposeMail(int Priority, bool? SMS, string Subject, string Message, Int64 Sid, Int64 Rid)
        {
            var sqlParam = new SqlParameter[] {
            ...
            var sqlQuery = @"Sp_NewComposeMail @priority,@sms,@sub,@msg,@sid,@rid";
